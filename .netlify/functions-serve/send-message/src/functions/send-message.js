...
var require_db = __commonJS({
  "node_modules/mime-types/node_modules/mime-db/db.json"(exports, module2) {
    module2.exports = {
...
var require_mime_db = __commonJS({
  "node_modules/mime-types/node_modules/mime-db/index.js"(exports, module2) {
...
// functions/send-message.ts
__export(exports, {
  handler: () => handler
});

// functions/utils/mailgun.ts
var import_form_data = __toModule(require_form_data());
var import_node_fetch = __toModule(require_lib2());
var AUTHTOKEN = `Basic ${Buffer.from(`api:${process.env.MAILGUN_API_KEY}`).toString(`base64`)}`;
