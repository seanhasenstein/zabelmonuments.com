...
const frequentlyAskedQuestions = [
  ...
  },
  {
    ...
    a:
      'Only you will know when it is time to stop in and talk to us. Some families choose to come in just a short time after while others take a year or two to finally feel they are emotionally ready to discuss this purchase.',
    isLink: false,
  },
  {
    id: 3,
  ...
  },
  {
    ...
    a:
      'This depends on a lot of things. If you select a piece that we have in stock, the normal delivery time is about 3 weeks. If we have to special order the granite, it could take 2-3 months for us to receive it from the quarry. We then have to do the engraving and schedule the delivery.',
    isLink: false,
  },
  {
    id: 7,
